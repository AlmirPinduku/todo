            ...
            <div class="col-lg-12">
                <form action="edit.php" method="POST">
                    <div class="d-flex align-items-center justify-content-between mt-10">
                        ...
                        <input type="text" class="w-full border border-black p-3 rounded-lg "
                            value="<?= $todo['todo']; ?>" name="todo" placeholder="Enter Your to do">

                        <button type="submit" name="todo_update"
                            class="float-right bg-[#12b76a] px-24 ml-4 py-3 rounded-lg text-white">Update</button>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        if ($todo['status'] == 1) { ?>
                                                ...
                                                <div
                                                    class="flex items-center border-2 border-[#d0d5dd] p-2.5 px-16 py-3 rounded-lg mr-2">
                                                    <a href="edit.php?id=<?= $todo['id']; ?>" class="" id="id">Edit</a>
                                                </div>
